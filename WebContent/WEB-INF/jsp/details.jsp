...
<body data-offset="200" data-spy="scroll" data-target=".ow-navigation">
		...
		<div class="page-banner gallerysingle-banner container-fluid no-padding">
			<div class="banner-content">
				...
				<ol class="breadcrumb">
					...
					<li><a href="gallery.html" title="Gallery">最近动态</a></li>							
		...
		<div class="gallery-single container-fluid no-padding">
			...
			<div class="container">
				...
				<div class="flexslider gallery-details-thumb">
					<ul class="slides">
						<li>
							<img src="${pageContext.request.contextPath}/images/thumb-1.jpg" alt="thumb" />
						</li>
						<li>
							<img src="${pageContext.request.contextPath}/images/thumb-2.jpg" alt="thumb" />
						</li>
						<li>
							<img src="${pageContext.request.contextPath}/images/thumb-3.jpg" alt="thumb" />
						</li>
						<li>
							<img src="${pageContext.request.contextPath}/images/thumb-1.jpg" alt="thumb" />
						</li>
				...
				<div class="description-section">
					<h3 class="info-heading">作者：啊啊 时间：2018-15-5</h3>
	...
	<!-- Library - Js -->
	<script src="${pageContext.request.contextPath}/libraries/lib.js"></script><!-- Boo${pageContext.request.contextPath}/libraries/File v3.3.5 -->
