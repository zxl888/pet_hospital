        ...
        <div class="gallery-single container-fluid no-padding">
            ...
            <div class="container">
                <div class="description-section">
                    <h3 class="info-heading">就医须知</h3>
                    <p class="info-content">一　楼：急诊科、儿科、儿保门诊、便民门诊、普外科、口腔门诊、肠道门诊、发热门诊</p>
                    <p class="info-content">二　楼：内分泌科、脾胃病（消化）科、脑病科、心血管内科、肺病科（呼吸科）、肾病科、风湿病科、肝病科、针灸科、骨伤科（疼痛科）</p>
                    <p class="info-content">三　楼：名医馆、名中医传承工作室、中医妇科、乳腺甲状腺科、耳鼻喉科、眼科、肿瘤科、外一科（脑外科）、外二科（普外科）、外三科（泌尿外科）、PICC门诊</p>
                    <p class="info-content">四　楼：皮肤美容科、妇产科、周围血管科、肛肠科
                    住院部 </p>
                	<p class="info-content">B栋一楼：体检中心 </p></p>
            		<p class="info-content">B栋二楼：治未病中心</p>
                    <p class="info-content">凭借阵容强大的专家团队、顶尖的专业技术，先进的管理制度、严谨规范的作业流程，美联众合每年为几十万客户提供高品质的产品和优质的服务。经营范围涵盖：宠物医疗、宠物保健、美容造型、留置护理（寄养）、洗浴SPA、食品及用品等。</p></div>
            </div><!-- Container /- -->
        </div><!-- 就医须知 -->
    </main>
    <!-- Footer Main -->
