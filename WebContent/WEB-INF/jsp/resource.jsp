		...
		<div class="gallery-section gallery-section-1 container-fluid">
			...
			<div class="container">
				...
				<ul id="filters" class="portfolio-categories no-left-padding">
					...
					<li><a data-filter=".design" href="#">手术室</a></li>
					<li><a data-filter=".video" href="#">检验科</a></li>
					<li><a data-filter=".photography" href="#">影像中心 </a></li>
					<li><a data-filter=".web" href="#">住院部 </a></li>
				</ul>
					...
					<li class="col-md-4 col-sm-4 col-xs-6 design">
						<div class="content-image-block">
							...
							<div class="content-block-hover">
								<h5>beach view</h5>
								<p>Victoria.</p>
								<a class="zoom" href="${pageContext.request.contextPath}/images/gallery-1.jpg" title="Expand"><i class="fa fa-search"></i></a>
					...
					<li class="col-md-4 col-sm-4 col-xs-6 video">
						<div class="content-image-block">
							...
							<div class="content-block-hover">
								<h5>beach view</h5>
								<p>Victoria.</p>
								<a class="zoom" href="${pageContext.request.contextPath}/images/gallery-2.jpg" title="Expand"><i class="fa fa-search"></i></a>
								<a href="gallery-single.html" title="Link"><i class="fa fa-external-link"></i></a>
							</div>
						</div>
					</li>
					<li class="col-md-4 col-sm-4 col-xs-6 photography">
						<div class="content-image-block">
							...
							<div class="content-block-hover">
								<h5>beach view</h5>
								<p>Victoria.</p>
								<a class="zoom" href="${pageContext.request.contextPath}/images/gallery-3.jpg" title="Expand"><i class="fa fa-search"></i></a>
								<a href="gallery-single.html" title="Link"><i class="fa fa-external-link"></i></a>
							</div>
						</div>
					</li>
					<li class="col-md-4 col-sm-4 col-xs-6 design">
						<div class="content-image-block">
							...
							<div class="content-block-hover">
								<h5>beach view</h5>
								<p>Victoria.</p>
								<a class="zoom" href="${pageContext.request.contextPath}/images/gallery-4.jpg" title="Expand"><i class="fa fa-search"></i></a>
								<a href="gallery-single.html" title="Link"><i class="fa fa-external-link"></i></a>
							</div>
						</div>
					</li>
					<li class="col-md-4 col-sm-4 col-xs-6 photography">
						<div class="content-image-block">
							...
							<div class="content-block-hover">
								<h5>beach view</h5>
								<p>Victoria.</p>
								<a class="zoom" href="${pageContext.request.contextPath}/images/gallery-5.jpg" title="Expand"><i class="fa fa-search"></i></a>
								<a href="gallery-single.html" title="Link"><i class="fa fa-external-link"></i></a>
							</div>
						</div>
					</li>
					<li class="col-md-4 col-sm-4 col-xs-6 web">
						<div class="content-image-block">
							...
							<div class="content-block-hover">
								<h5>beach view</h5>
								<p>Victoria.</p>
								<a class="zoom" href="${pageContext.request.contextPath}/images/gallery-6.jpg" title="Expand"><i class="fa fa-search"></i></a>
								<a href="gallery-single.html" title="Link"><i class="fa fa-external-link"></i></a>
							</div>
						</div>
					</li>
		...
		<div class="top-footer">
			...
			<div class="container">
				...
				<aside class="col-md-3 col-sm-6 col-xs-6 ftr-widget widget_about">
					...
					<p>天使宠物医院是集教学、科研 、临床为一体的的正规化、现代化、专业化大型连锁宠物诊疗机构。由西南大学副教授郑晓波博士1992年始创于成都，在郑小波博士的带领下，经爱美森人多年的努力，现已建成以爱美森兽医医院资源中心广西总部为中心辐射四川、重庆、西藏、西双版纳等大中城市50余家天使宠物诊疗机构网络，并培养了一大批综合素质高，临床经验丰富的人才队伍。</p>
					<ul>
						<li><a href="#" title="Facebook"><i class="fa fa-facebook"></i></a></li>
						<li><a href="#" title="Twitter"><i class="fa fa-twitter"></i></a></li>
						<li><a href="#" title="Google"><i class="fa fa-google-plus"></i></a></li>
