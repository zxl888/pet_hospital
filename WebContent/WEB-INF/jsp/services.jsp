        ...
        <div class="service-section container-fluid">
            ...
            <div class="container">
                ...
                <div class="col-md-4 col-sm-6 col-xs-6 service-box">
                    <img src="${pageContext.request.contextPath}/images/service-1.jpg" alt="service" />
                    <div class="service-content">
                        <h5>猫专科</h5>
                        <p>安安宠医是国内先进的猫专科服务连锁医院，按照国际标准建立猫诊所，以猫为本，致力于减少猫咪到诊所而导致的应激，也让猫主人拜访宠物医生变得更容易更舒适。猫专用诊室和候诊区，“无犬环境”，隔绝噪音打扰，更温和就诊体验。猫专用住院部，单独笼位，复式设计，实现一室一厅一卫，更宽敞舒适的活动空间。猫寄养乐园，分豪华玻璃笼位和散放笼位，与猫乐园无缝连接，活动时间单独出来玩耍，满足喵星人上下跳跃的需求。</p>
                        <a href="#" class="read-more" title="Read More">马上预约</a>
                        <a href="#" class="link"><i class="fa fa-caret-right"></i></a>
                    </div>
                </div>
                <div class="col-md-4 col-sm-6 col-xs-6 service-box">
                    <img src="${pageContext.request.contextPath}/images/service-2.jpg" alt="service" />
                    <div class="service-content">
                        <h5>猫专科</h5>
                        <p>安安宠医是国内先进的猫专科服务连锁医院，按照国际标准建立猫诊所，以猫为本，致力于减少猫咪到诊所而导致的应激，也让猫主人拜访宠物医生变得更容易更舒适。猫专用诊室和候诊区，“无犬环境”，隔绝噪音打扰，更温和就诊体验。猫专用住院部，单独笼位，复式设计，实现一室一厅一卫，更宽敞舒适的活动空间。猫寄养乐园，分豪华玻璃笼位和散放笼位，与猫乐园无缝连接，活动时间单独出来玩耍，满足喵星人上下跳跃的需求。</p>
                        <a href="#" class="read-more" title="Read More">马上预约</a>
                ...
                <div class="col-md-4 col-sm-6 col-xs-6 service-box">
                    <img src="${pageContext.request.contextPath}/images/service-3.jpg" alt="service" />
                    <div class="service-content">
                        <h5>猫专科</h5>
                        <p>安安宠医是国内先进的猫专科服务连锁医院，按照国际标准建立猫诊所，以猫为本，致力于减少猫咪到诊所而导致的应激，也让猫主人拜访宠物医生变得更容易更舒适。猫专用诊室和候诊区，“无犬环境”，隔绝噪音打扰，更温和就诊体验。猫专用住院部，单独笼位，复式设计，实现一室一厅一卫，更宽敞舒适的活动空间。猫寄养乐园，分豪华玻璃笼位和散放笼位，与猫乐园无缝连接，活动时间单独出来玩耍，满足喵星人上下跳跃的需求。</p>
                        <a href="#" class="read-more" title="Read More">马上预约</a>
                    ...
                    <ul class="portfolio-list no-left-padding">
                        <li class="col-md-4 col-sm-4 col-xs-6 design">
                            <div class="content-image-block">
                                <img src="${pageContext.request.contextPath}/images/gallery-7.jpg" alt="gallery">
							</div>
                        </li>
                        <li class="col-md-4 col-sm-4 col-xs-6 design">
                            <!-- Section Header -->
                            <div class="section-header">
                                <h3>环境配置</h3>
                                <p>安安宠医参照国际动物医院标准和理念全新装修，以高端优雅的诊疗环境，高效严谨的服务体系和高标准的医疗技术服务于每一位宠物和宠主</p>
                                <a href="#" title="view all categories">查看所有</a>
                            </div><!-- Section Header /- -->
                        </li>
                        <li class="col-md-4 col-sm-4 col-xs-6 design">
                            <div class="content-image-block">
                                <img src="${pageContext.request.contextPath}/images/gallery-10.jpg" alt="gallery">
							</div>
                        </li>
                        <li class="col-md-4 col-sm-4 col-xs-6 design">
                            <div class="content-image-block">
                                <img src="${pageContext.request.contextPath}/images/gallery-9.jpg" alt="gallery">
							</div>
                        </li>
                        <li class="col-md-4 col-sm-4 col-xs-6 design">
                            <div class="content-image-block">
                                <img src="${pageContext.request.contextPath}/images/gallery-11.jpg" alt="gallery">
							</div>
                        </li>
                        <li class="col-md-4 col-sm-4 col-xs-6 design">
                            <div class="content-image-block">
                                <img src="${pageContext.request.contextPath}/images/gallery-8.jpg" alt="gallery">
							</div>
                        </li>
                    </ul>
                </div><!-- Row /- -->
                ...
                <div class="testimonial-carousel-2">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="testimonial-content">
                            <i><img src="${pageContext.request.contextPath}/images/testi-1.jpg" alt="testi" /></i>
                            <p>我的猫猫小智从那时很小刚来家里的时候，我就在这家医院找周医生看病，看着周医生医术越来越好，护士姐姐也越来越漂亮温柔，医院设备越来越齐全，即使家住在新都也要折腾大半个成都市来这里看病，更加庆幸坚定在这里做各种治疗的决定。</p>
                            <h5>@dpuser<span>(CEO of Boston Group)</span></h5>
                        </div>
                    </div>
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="testimonial-content">
                            <i><img src="${pageContext.request.contextPath}/images/testi-2.jpg" alt="testi" /></i>
                            <p>我的猫猫小智从那时很小刚来家里的时候，我就在这家医院找周医生看病，看着周医生医术越来越好，护士姐姐也越来越漂亮温柔，医院设备越来越齐全，即使家住在新都也要折腾大半个成都市来这里看病，更加庆幸坚定在这里做各种治疗的决定。</p>
                            <h5>@dpuser<span>(CEO of SAS Insititute)</span></h5>
                        </div>
                    </div>
                </div>
            </div><!-- Container /- -->
